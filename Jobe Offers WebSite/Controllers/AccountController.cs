...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Ajout sur la table AspUserRole relation avec Role . 
        ...
        // soufiane appel methode (Model/AccountViewModel :: EditProfileViewModel)
        ...
        public ActionResult EditProfile(EditProfileViewModel profile)
        {
            ...
            // verifier le mot de passe . (ctrl + k + d)
            ...
            else
            {
                ...
                ViewBag.Message = "تمة عملية التحديث بنجاح";
            }
